    ...
    <section className="py-16 sm:py-24 bg-background">
      <div className="container mx-auto text-center">
        ...
        <div className="relative mt-12 w-full overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-background to-transparent" />
          <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-background to-transparent" />
        </div>
      </div>
    </section>
  );
